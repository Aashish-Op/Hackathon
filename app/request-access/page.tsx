    ...
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink)]">
      ...
      <main className="mx-auto w-full max-w-[900px] px-6 py-16">
        <div className="border border-[rgba(26,26,26,0.15)] bg-[var(--tint)] p-8 md:p-10">
          <p className="font-[family-name:var(--font-geist-mono)] text-[11px] uppercase tracking-[0.1em] text-[var(--red)]">REQUEST ACCESS</p>
          <h1 className="mt-4 font-[family-name:var(--font-dm-serif-display)] text-[40px] leading-[1.1]">Create your account now</h1>
          <p className="mt-3 text-sm text-[var(--muted)]">
            Self-serve onboarding is enabled for this demo workspace.
          </p>
          <div className="mt-6">
            <Link href="/register" className="inline-flex rounded-[4px] bg-[var(--red)] px-5 py-2 text-sm text-[var(--paper)]">
              Create account
            </Link>
          </div>
        </div>
